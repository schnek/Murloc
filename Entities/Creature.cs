...
namespace WowHeadParser.Entities
{
    ...
    class QuestStarterEnderParsing
    {
        ...
        public QuestStarterEnderParsing(int money)
        {
            this.money = money;
        }
    }
    ...
    class Creature : Entity
    {
        ...
        public override String GetSQLRequest()
        {
            ...
            if (IsCheckboxChecked("Locale"))
            {
                ...
                if (localeIndex != 0)
                {
                    m_creatureLocalesBuilder = new SqlBuilder("locales_creature", "id");
                    m_creatureLocalesBuilder.SetFieldsNames("language_code", "Name", "subname");
